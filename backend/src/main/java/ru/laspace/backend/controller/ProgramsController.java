...
public class ProgramsController {
        ...
        @PostMapping("/create")
        public ResponseEntity<Map<String, Integer>> createProgram(@Valid @RequestBody ProgramCreateRequest request) {
                ...
                log.info("Количество режимов в запросе: {}",
                                request.getModes() != null ? request.getModes().size() : 0);

                Integer generatedNumRp = programsService.saveProgram(request);
        ...
        public ResponseEntity<String> generatePr03(@PathVariable Integer numRp,
                        @PathVariable Integer numKa) {
