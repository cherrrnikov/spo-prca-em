...
import ru.laspace.backend.dto.input.forecast.ForecastDto;
import ru.laspace.backend.dto.input.forecast.ShadowDto;
import ru.laspace.backend.dto.input.forecast.ZasvetkaDto;
import ru.laspace.backend.repository.input.ForecastRepository;
