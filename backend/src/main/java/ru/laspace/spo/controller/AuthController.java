...
public class AuthController {
    ...
    @Operation(summary = "Выход из системы", description = "Завершение сессии и отзыв refreshToken")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> logout(
            @Parameter(description = "JWT", required = true, hidden = true) @RequestHeader(value = "Authorization", required = false) String authHeader,
            @Parameter(description = "Текущий пользователь", hidden = true) @AuthenticationPrincipal UserDetailsImpl userDetails) {
